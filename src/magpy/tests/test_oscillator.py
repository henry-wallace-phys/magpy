...
TEST_DATA = [
    (
        ...
        torch.tensor(
            [
                0.9714637292473465,
                0.011164541494939489,
                0.017371729257714037,
                0.024013341497295105,
                0.18766387659674955,
                0.7883227819059554,
                0.00452292925535842,
                0.801171581908311,
                ...
                0.3909915304599606,
                0.9598862328001443,
                0.025676407527673743,
                0.014437359672181967,
                0.0024712562438703543,
                0.4027676101665143,
                0.5947611335896154,
                0.03764251095598536,
                0.571555982305812,
                ...
                0.08220067407098837,
                0.03469291921810029,
                0.055281434094292134,
                0.1818123615901669,
                0.762906204315541,
                0.061612159194796526,
                0.7359869643388447,
                0.20240087646635874,
            ],
            dtype=torch.float64,
    ...
    (
        ...
        torch.tensor(
            [
                ...
                0.39901275849887163,
                0.9570817334818662,
                0.032293704371769205,
                0.010624562146364591,
                0.032293704371769205,
                0.3725708125831583,
                0.5951354830450725,
                0.010624562146364591,
    ...
    (
        ...
        torch.tensor(
            [
                0.9706989055596977,
                0.018497624584948653,
                0.010803469855353614,
                0.018497624584948653,
                0.18539537941104356,
                0.7961069960040078,
                0.010803469855353614,
...
def test_oscillator(
    ...
    for E_ENERGY in energy_range:
        final_osc_chans.extend(
            [(in_, out) for in_ in osc_channels for out in osc_channels]
        )
