...
@click.option('--out_folder', default='benchmarks/results', type=str, help='Output folder for benchmark results')
def main(n_iter: int = 50, points: int = 10, n_osc_scales: int = 100000, out_folder: str = "benchmarks/results"):
    ...
    plot_average_time_per_event(times, scales, plot_file=f"{out_folder}/osc_average_time_event.png")